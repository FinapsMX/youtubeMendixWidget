...
public class Microflows
{
	...
	public static testsuite.proxies.youtube ds_youtube(IContext context)
	{
		try
		{
			Map<String, Object> params = new HashMap<String, Object>();
			IMendixObject result = (IMendixObject)Core.execute(context, "TestSuite.ds_youtube", params);
			return result == null ? null : testsuite.proxies.youtube.initialize(context, result);
		}
